...
function LoginContent() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-[#F5F5F5]">
      <div className="bg-white border border-[#E8E8E8] rounded-2xl p-8 w-full max-w-sm text-center shadow-lg">
        <h1 className="text-2xl font-bold text-[#EE4D2D] mb-1">NONICS MANTAP</h1>
        <p className="text-[#999999] text-sm mb-6">Sales Dashboard</p>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 bg-[#EE4D2D] text-white font-medium rounded-lg px-4 py-3 hover:bg-[#D73211] transition-colors"
        >
        ...
        <p className="text-[#999999] text-xs mt-6">Akses terbatas untuk email yang terdaftar</p>
      </div>
    </div>
  );
}
