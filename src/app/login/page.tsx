  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: "#0A0A0F" }}>
      <div className="glass p-8 w-full max-w-sm text-center">
        ...
        <p className="text-[#6B6B78] text-sm mb-6">Sales Dashboard</p>

        {error && (
          <div className="bg-red-500/10 border border-red-500/25 rounded-lg px-4 py-3 mb-4">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 bg-gradient-to-r from-[#F5A623] to-[#F0C040] text-[#0A0A0F] font-semibold rounded-lg px-4 py-3 hover:shadow-[0_0_24px_rgba(245,166,35,0.3)] transition-all"
        >
        ...
        <p className="text-[#6B6B78] text-xs mt-6">Akses terbatas untuk email yang terdaftar</p>
      </div>
    </div>
  );
}
